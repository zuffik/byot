import {TrainingSetUpdate} from './TrainingSetUpdate';
...
import {Request, Response} from '@byot-frontend/common/src/redux/process/training-set/TrainingSetUpdate';
...
describe('TrainingSetUpdate process', () => {
  let process: TrainingSetUpdate;
  let request: Action<Request>;
  let response: Action<AsynchronousActionResponse<Request, Response>>;

  beforeEach(() => {
    process = new TrainingSetUpdate();
    request = ProcessActionExtractor.dispatch(TrainingSetUpdate, {id: 'id', trainingSet: trainingSet()});
