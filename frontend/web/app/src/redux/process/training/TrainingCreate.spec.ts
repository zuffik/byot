...
import {Request, Response} from '@byot-frontend/common/src/redux/process/training/TrainingCreate';
...
describe('TrainingCreate process', () => {
  let process: TrainingCreate;
  let request: Action<Request>;
  let response: Action<AsynchronousActionResponse<Request, Response>>;

  beforeEach(() => {
    process = new TrainingCreate();
    request = ProcessActionExtractor.dispatch(TrainingCreate, trainingDraftInput());
